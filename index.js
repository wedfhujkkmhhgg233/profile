      ...
      <div class="profile-card__cnt js-profile-cnt">
        ...
        <div class="profile-card-inf">
          <div class="profile-card-inf__item">
            <div class="profile-card-inf__title">Project</div>
            <div class="profile-card-inf__txt">4</div>
          </div>
          <div class="profile-card-inf__item">
        ...
        <div class="profile-card-ctr">
          <a href="/docs">
          <button
            class="profile-card__button button--blue js-message-btn">REST API</button>
          </a>
        </div>
      </div>
    </div>
